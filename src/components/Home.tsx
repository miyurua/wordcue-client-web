    ...
    <div className="flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-[#008080] h-screen">
      <div className="flex items-center justify-center md:w-1/2 p-4">
        <div className="flex flex-col space-y-4">
          <h1 className="text-8xl font-semibold text-[#008080]">
            Disambiguation
          </h1>
          <h1 className="text-8xl font-semibold text-gray-800">Made Easy</h1>
        </div>
      </div>
      <div className="flex flex-col md:w-1/2 p-4 space-y-6 justify-center pl-11">
